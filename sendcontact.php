...
define( "RECIPIENT_NAME", "Green Harvest Hello" ); //UPDATE THIS TO YOUR NAME
define( "RECIPIENT_EMAIL", "hello@greenharvest.xyz" ); //UPDATE THIS TO YOUR EMAIL ID
define( "EMAIL_SUBJECT", "GH Visitor Message" ); //UPDATE THIS TO YOUR SUBJECT
